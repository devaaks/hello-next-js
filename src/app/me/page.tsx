          ...
          <div className="flex items-center flex-col md:flex-row">
            ...
            <div className="text-center md:text-left">
              ...
              <div className="flex justify-center md:justify-start space-x-4">
                <a href={`https://github.com/${user.github}`} className="text-gray-400 hover:text-gray-500">
                ...
                <a href={`https://twitter.com/${user.twitter}`} className="text-gray-400 hover:text-gray-500">
          ...
          <div className="space-y-6">
            {user.blogPosts.map((post) => (
              <div key={post.title} className="group cursor-pointer">
                ...
                <p className="text-sm text-gray-500 mt-1">{post.readTime} read</p>
              </div>
            ))}
          </div>
        </div>
