    ...
    return (
        <div className="min-h-screen p-8">
          <div className="max-w-4xl mx-auto p-10 rounded shadow">
            ...
            <p className="mb-6">
              Welcome to the Next.js documentation page. Here, you'll find resources and guides to help you get started with building server-rendered React applications.
            </p>
